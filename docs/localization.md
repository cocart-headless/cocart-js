...
import '@cocart/sdk/i18n/fr'; // registers French (once available)
...
```ts
import { setLocale } from '@cocart/sdk';
import '@cocart/sdk/i18n/fr';
...
```ts
import { registerLocale, setLocale, getLocale, t } from '@cocart/sdk';
```
